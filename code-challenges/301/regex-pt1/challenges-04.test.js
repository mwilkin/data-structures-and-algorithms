...
const isCapitalized = (str) => {
  let regCapital = /[A-Z][a-z]+/g;
  return str.match(regCapital);
...
const citiesAtoJ = (arr) => {
  let results = [];
  let citiesRegex = /[A-J][a-z]+/g;
  arr.forEach(element => {
    if(citiesRegex.test(element)){
...
const noPunctuation = str => {
  let magicStuff = /\w+\s/g;
  return str.match(magicStuff);
};
...
const findShells = (str) => {
  // let magicStuff = /ells$/g;
  // let holdingArr = [];
  // if(str.match(magicStuff).holdingArr.push()
  // )
};
